...
from utils import check_authentication, photo_exists, select_resident_widget
...
resident = select_resident_widget(db, key_prefix="view_resident")
...
if resident:
    ...
    medical_history = db.get_medical_history(resident['unique_id'])
